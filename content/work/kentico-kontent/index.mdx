...
_Figure 1 (Left): Technical model draft; Figure 2 (Right): Navigation sketches_
...
_Figure 3: Navigation to Environments in the main menu_

![Navigation to Environments in the Settings section](../../assets/kontent-env-nav-v2.png)
_Figure 4: Navigation to Environments in the Settings section_
