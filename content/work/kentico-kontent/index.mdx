...
- **Problem**: Giving developers working with Kentico Kontent the option to safely develop new functionality without breaking anything.
- **Solution**: Building environments – a way to create a safe space for developers to work in.
- **Team**: Product manager, product team of 4 engineers and me.
- **Result**: Shipped feature successfully adopted by enterprise customers.
