...
In Autumn 2019, developers had to make all changes on the production instance of the system. That was potentially dangerous as it could affect live content.

We knew that **developing new functionality to a website or change an existing one often required updating the content models** in Kentico Kontent and that could result in breaking the website.
