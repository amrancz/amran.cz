                ...
                <div className={'flex flex-row pb-6 items-center font-medium space-x-4'}>
                  ...
                  <Link to={'/work'}>
                    <div id="intro" className={`flex max-w-[11rem] border border-solid border-${post.frontmatter.color}-300 text-${post.frontmatter.color}-300 hover:text-${post.frontmatter.color}-100 duration-150 items-center rounded-xl p-2 space-x-2`}>
                      {/* purgecss: text-yellow-200 border-yellow-900 text-yellow-900 text-blue-200 border-blue-900 border-blue-300 text-blue-300 hover:text-blue-100 border-yellow-900 border-yellow-300 text-yellow-300 hover:text-yellow-100 */}
                      <span>← Work</span>
                    </div>
                  </Link>
                </div>
